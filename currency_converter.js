...
let ShowBanner = async () => {
    await showBanner("Currency Converter", "You can convert any currency to any currency");
};
// Function to get the amount from the user
let userAmount = async () => {
    let input;
    while (true) {
